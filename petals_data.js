...
const PETALS_DATA = {
    ...
    DESCRIPTIONS: {
        ...
        venom: '毒液花瓣，施加持续中毒伤害效果',
        shield: '护盾花瓣，激活后生成临时护盾吸收伤害',
    ...
    HEALTH: {
        ...
        leaf: [0, 12, 24, 48, 96, 192, 384, 768, 1536, 3072, 6144, 12288, 24576, 49152, 98304, 196608, 393216, 786432, 1572864, 3145728],
        ...
        bomb: [0, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288, 1048576, 2097152, 4194304],
        ...
        square: [0, 200, 600, 1800, 5400, 16200, 48600, 145800, 437400, 1312200, 3936600, 11809800, 35429400, 106288200, 318864600, 956593800, 2869781400, 8609344200, 25828032600, 77484097800]
    },

    // 花瓣体伤数据 (1-19级)
    BODY_DAMAGE: {
        missile: [0, 25, 75, 225, 675, 2025, 6075, 18225, 54675, 164025, 492075, 1476225, 4428675, 13286025, 39858075, 119574225, 358722675, 1076168025, 3228504075, 9685512225],
        ...
        leaf: [0, 13, 39, 117, 351, 1053, 3159, 9477, 28431, 85293, 255879, 767637, 2302911, 6908733, 20726199, 62178597, 186535791, 559607373, 1678822119, 5036466357],
        ...
        thunder: [0, 20, 60, 180, 540, 1620, 4860, 14580, 43740, 131220, 393660, 1180980, 3542940, 10628820, 31886460, 95659380, 286978140, 860934420, 2582803260, 7748409780],
        ...
        stinger: [0, 18, 54, 162, 486, 1458, 4374, 13122, 39366, 118098, 354294, 1062882, 3188646, 9565938, 28697814, 86093442, 258280326, 774840978, 2324522934, 6973568802],
        orange: [0, 18, 54, 162, 486, 1458, 4374, 13122, 39366, 118098, 354294, 1062882, 3188646, 9565938, 28697814, 86093442, 258280326, 774840978, 2324522934, 6973568802],
        ...
        square: [0, 10, 30, 90, 270, 810, 2430, 7290, 21870, 65610, 196830, 590490, 1771470, 5314410, 15943230, 47829690, 143489070, 430467210, 1291401630, 3874204890]
    },
    ...
    HEAL: {
        ...
        leaf: [0, 1.3, 2.6, 5.2, 10.4, 20.8, 41.6, 83.2, 166.4, 332.8, 665.6, 1331.2, 2662.4, 5324.8, 10649.6, 21299.2, 42598.4, 85196.8, 170393.6, 340787.2],
    ...
    SPECIAL_MECHANICS: {
        ...
        venom: {
            ...
            poison_damage_factor: 0.3, // 中毒伤害系数
            type: 'poison'         // 毒液效果
        },
        shield: {
    ...
    getPetalStatsText(petalType, level = 1) {
        ...
        if (mechanics) {
            switch (data.type) {
                ...
                case 'thunder':
                    const chainRange = mechanics.chain_range + (level - 1) * 150;
                    const maxChains = mechanics.max_chain + level;
